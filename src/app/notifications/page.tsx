  ...
  return (
    <ShopperLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20">
        {/* Header */}
        <header className="sticky top-0 z-30 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md px-4 lg:px-8 py-4 dark:text-white border-b border-gray-200 dark:border-gray-800">
          <div className="w-full max-w-4xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Real-time alerts on near-expiry deals & orders</p>
              </div>
            </div>
            {notifications.some((n) => !n.is_read) && (
              <button
                onClick={handleMarkAllAsRead}
                className="text-xs sm:text-sm font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 transition-colors px-3 py-1.5 rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-950/40 cursor-pointer"
              >
                Mark all as read
              </button>
            )}
        ...
        {/* Notifications List */}
        <main className="p-4 lg:p-8 max-w-4xl mx-auto space-y-3">
          {!user ? (
            ...
            <div className="py-20 text-center bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-8 shadow-xs">
              <div className="bg-gray-100 dark:bg-gray-800 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Bell size={24} className="text-gray-400" />
              </div>
            ...
            notifications.map((notif, i) => {
              ...
              return (
                ...
                >
                  <div className={`p-3 rounded-2xl flex-shrink-0 self-start ${color}`}>
                    <Icon size={20} />
                  </div>
